...
class TensorSliceTests: XCTestCase {
    ...
    func testSlice() {
        ...
        do {
            ...
            XCTAssertEqual(slice.elements, [6.0, 7.0, 11.0, 12.0, 26.0, 27.0, 31.0, 32.0])
        }
        
        do {
            let slice = tensor[nil, nil, 0..<1]
            XCTAssertEqual(slice.shape, [3, 4, 1])
            XCTAssertEqual(slice.elements, [0.0, 5.0, 10.0, 15.0, 20.0, 25.0, 30.0, 35.0, 40.0, 45.0, 50.0, 55.0])
        }
    }
    ...
    func testSliceOfSlice() {
        ...
        XCTAssertEqual(sliceOfSlice.elements, [6.0, 7.0, 11.0, 12.0, 26.0, 27.0, 31.0, 32.0])
    }
